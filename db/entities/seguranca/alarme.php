...
Class Alarme {
    ...
    public static function read($id = null, $id_usuario = null, $filtro_hora_inicio = null, $filtro_hora_final = null) {
        ...
        if($filtro_hora_inicio != null) $conditions[] = 'created_at >= :filtro_hora_inicio';
        if($filtro_hora_final != null) $conditions[] = 'created_at <= :filtro_hora_final AND scheduled_at <= :filtro_hora_final';
