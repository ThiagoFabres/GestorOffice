    ...
    <div class="tabela">
        ...
        <div class="card-header-borda">
            <div class="tab-pane fade show active" id="vendas" role="tabpanel" aria-labelledby="vendas-tab">
                ...
                <tbody>
            <?php
            $parcelas = Pag02::read(null, $_SESSION['usuario']->id_empresa);
            if (!empty($parcelas)) {
                $recebimentos_pagos = [];?>
                        ...
                        $pag01 = Pag01::read($pag02->id_pag01, $_SESSION['usuario']->id_empresa )[0];
                            ...
                            <tr class="tr-clientes" onclick="" 
                             ...
                             >
                                ...
                                <td>
                                    <button class="btn btn-primary" data-bs-toggle="modal" <?php if($pag02->valor_pag == $pag02->valor_par){ ?> disabled <?php } ?> data-bs-target="#modal_quitar" data-id="<?=$pag02->id?>" data-valor-restante="<?= $pag02->valor_par - $pag02->valor_pag ?>">Quitar</button>
                                    ...
                                    <a class="btn btn-primary" <?php if($parcelas_pagas == true){ ?> disabled <?php } ?> href="editar-pagar.php?id=<?=$pag02->id?>">Editar</a>
                                </td>
                            </tr>
