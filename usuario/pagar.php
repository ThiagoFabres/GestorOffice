...
<body id="body">
    ...
    <div class="main" id="container">
        ...
        <div class="relatorios-botoes w-100" style="float: left;">
            <button class="btn btn-primary btn-sm" id="botao-gerar-pdf" onclick="<?php if($get_pdf || $get_excel) { echo "gerarpdf('pagar', document.querySelector('#nome-empresa h1').innerHTML)";} else {?>window.location.href='<?=$caminho?><?= empty($filtros) ? '?' : '&' ?>pdf=1' <?php } ?>">Gerar PDF</button>
