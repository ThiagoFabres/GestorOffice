...
if(isset($view) && $view == 'contas'){
    ...
    if(isset($get_id)) {
    $pag02_target = Pag02::read($get_id,$_SESSION['usuario']->id_usuario)[0];
    $recebimento = Pag01::read($pag02_target->id_pag01,$_SESSION['usuario']->id_usuario)[0];
...
<?php $post_cadastro = filter_input(INPUT_POST, 'cadastro');
        ...
        $parcelas = Pag02::read(null,$_SESSION['usuario']->id_empresa, $recebimento->id);
