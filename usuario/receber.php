        ...
        <div class="row">
            <div class="col-md-12" style="padding: 0;">
                ...
                <?php } ?>
                    ...
                    <?php require_once __DIR__ . '/../componentes/card-headers/financeiro/receber/card-header.php' ?>
                    <?php require_once __DIR__ . '/../componentes/tabelas/financeiro/receber/tabela-receber.php' ?>
