...
<div class="card-header">
    ...
    <button class="btn btn-primary dre-menu-btn" <?php if($dre_target == 'grafico_operacional') echo 'style="border-bottom: 2px solid #5856d6;"'; ?> onclick="window.location.href='grafico_operacional.php'"  id="btn-grafico-operacional">
        <h3>Gráfico Operacional</h3>
    </button>
