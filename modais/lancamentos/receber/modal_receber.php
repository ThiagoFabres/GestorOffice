                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" id="content" action="editar-receber.php"
                            ...
                            <div class="titulo-group">
                                ...
                                <div class="input-titulo input-form-adm" style="width: 80%;">
                                    <!--Nome: -->
                                ...
                                <div class="titulo-btn" style="width: 20%;">
                                    <button data-bs-toggle="modal" data-bs-target="#modal_titulo" type="button" class= "form-control">
                            ...
                            <div class="subtitulo-group">
                                ...
                                <div class="input-subtitulo input-form-adm" style="width: 80%;">
                                ...
                                <div class="subtitulo-btn" style="width: 20%;">
                                    <button data-bs-toggle="modal" data-bs-target="#modal_subtitulo" type="button" class="form-control">
                                        <i class="bi bi-plus-lg"></i>
                                    </button>
                                </div>
                                </div>
