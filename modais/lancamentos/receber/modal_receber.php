                        ...
                        <div class="card-header-div">
                            <?php if(!empty($parcelas)) echo '<div class="card-header-borda">'?> 
                                <div class="tab-pane fade show active" id="vendas" role="tabpanel"
                                    ...
                                    <form method="post" action="receber.php?view=receber&acao=editar"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="modal-input-group">
                                                ...
                                                <div class="input-documento-group">
                                                        ...
                                                        <div class="input-documento-generator" style="width:25%">
                                                            <button data-bs-toggle="modal" data-bs-target="#modal_cadastro_custos" type="button" class="form-control" id="btnModalCustos">
                                            ...
                                            <div class="modal-input-group">
                                                <label for="cadastro">Cliente / Fornecedor:</label>
                                                    <div class="input-documento-group">
                                                        ...
                                                        <div class="input-documento-generator" style="width:25%">
                                                            <button data-bs-toggle="modal" data-bs-target="#modal_cadastro" type="button"class="form-control" id="btnModalCadastro">
                                                                <i class="bi bi-plus-lg"></i>
                                                            </button>
                                                        </div>
                                                    </div>
